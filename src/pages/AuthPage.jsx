...
import { ShieldCheck, Car, ParkingSquare, Eye, EyeOff, Clock } from 'lucide-react';
      ...
      >
        ...
        {mode === 'signup' ? (
          <form onSubmit={doSignup}>
            ...
            <Field label="Password" required hint="At least 8 characters recommended">
              <div style={{ position: 'relative' }}>
                <input
            ...
            <Field label="Role" required>
              <div style={{ display: 'flex', gap: 10 }}>
                  ...
                  style={{
                    ...
                    border:
                      form.role === 'driver'
                        ? `2px solid ${C.blue}`
                        : `1px solid ${C.border}`,
                    background: form.role === 'driver' ? C.blueSoft : C.white,
                    cursor: 'pointer',
                    textAlign: 'left',
                    fontSize: 12
                  }}
                >
                  ...
                  <div style={{ color: C.slateL }}>Find and monitor secure parking.</div>
                </button>
                <button
                  type="button"
                  ...
                  style={{
                    ...
                    border:
                      form.role === 'host'
                        ? `2px solid ${C.blue}`
                        : `1px solid ${C.border}`,
                    background: form.role === 'host' ? C.blueSoft : C.white,
                    cursor: 'pointer',
                    textAlign: 'left',
                    fontSize: 12
                  }}
                >
                  ...
                  <div style={{ color: C.slateL }}>List and manage your spaces.</div>
                </button>
              </div>
            </Field>
            {error && (
          ...
          <form onSubmit={doSignin}>
            ...
            {lockoutMs > 0 && (
              ...
              >
                <Clock size={14} />
                <span>
                  Locked out for {Math.ceil(lockoutMs / 1000)}s due to repeated attempts.
                </span>
              </div>
            )}
            <button
